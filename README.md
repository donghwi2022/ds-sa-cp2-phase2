...
## 5. 프로젝트 결과
  - baseline 모델의 성능 : 모든 고객에게 빈도가 높은 상품 20개를 동일하게 추천한 결과의 평균
    - Average of precision@20 : 0.00013472549680026923
    - Average of recall@20 : 0.00036301053382020325
  - 추천 모델의 성능 : 각각의 고객에게 벡터 유사도가 높은 상품 20개를 추천한 결과의 평균
    - Average of precision@20 : 0.0001613899180419891
    - Average of recall@20 : 0.0004927032935038315
  - 결과 요약
